...
| [04-记忆系统](04-记忆系统.md) | Markdown 记忆 | 让 Agent 记住事实 |
| [05-向量存储](05-向量存储.md) | 向量库与语义检索 | 接入相似度检索 |
| [06-多智能体-ManagerWorker](06-多智能体-ManagerWorker.md) | Manager-Worker 协同 | 任务委派 |
| [07-顺序链-SequentialChain](07-顺序链-SequentialChain.md) | 串联多个 Agent | 流水线处理 |
| [08-Team与信箱通信](08-Team与信箱通信.md) | 多 Agent 异步通信 | Agent 间互发消息 |
| [09-任务系统-TaskStore](09-任务系统-TaskStore.md) | 任务依赖图 | 拆解带依赖的任务 |
| [10-钩子-Hooks](10-钩子-Hooks.md) | 生命周期钩子 | 审计、改写、拦截 |
| [11-权限系统](11-权限系统.md) | 工具执行权限 | 安全控制 |
| [12-上下文压缩与错误恢复](12-上下文压缩与错误恢复.md) | 长对话与稳定性 | 避免爆上下文 |
| [13-插件系统](13-插件系统.md) | 打包复用能力 | 一次编写多处复用 |
| [14-Web工具](14-Web工具.md) | 联网搜索与阅读 | 让 Agent 上网 |
| [15-配置与环境变量](15-配置与环境变量.md) | 全部配置项 | 灵活部署 |
| [16-测试指南](16-测试指南.md) | 写测试 | 保证质量 |
| [17-完整实战示例](17-完整实战示例.md) | 综合实战 | 串起全部功能 |
